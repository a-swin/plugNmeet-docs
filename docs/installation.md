...
## Requirements
  ...
  - You'll need a clean **Ubuntu or Debian** server with a **public IP address**. **Ubuntu 24.04 LTS** recommended. 22.04 is only working some otther version facing the Container plugnmeet-livekit-1  Error    
